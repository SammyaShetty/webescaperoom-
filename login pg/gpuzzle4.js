...
function initializePieces() {
    ...
    for (let i = 0; i < pieces.length; i++) {
        let tile = document.createElement("img");
        tile.src = `./gimages4/img${pieces[i]}.jpg`;
...
function checkSolution() {
    ...
    if (isSolved) {
        ...
        document.getElementById("level5Btn").style.display = "block";
...
function nextLevel() {
    ...
    window.location.href = "slevel5.html";
    // Logic for proceeding to level 2
}
function quitGame() {
    window.location.href = 'index3.html'; // Redirect to index.html
}